...
yystate(31, Ics, Line, Tlen, _, _) ->
    {14,Tlen,Ics,Line,31};
yystate(30, [8706|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [8230|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [8211|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [8212|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [323|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [248|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [239|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [233|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [225|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [193|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [180|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(30, [60|Ics], Line, Tlen, Action, Alen) ->
    yystate(33, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [59|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(30, [36|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(30, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 47 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(29, Ics, Line, Tlen+1, 12, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 96, C =< 122 ->
    yystate(29, Ics, Line, Tlen+1, 12, Tlen);
...
yystate(25, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
yystate(25, [C|Ics], Line, Tlen, Action, Alen) when C >= 96, C =< 122 ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
...
yystate(18, [32|Ics], Line, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(18, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 58 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(18, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,18};
yystate(17, [233|Ics], Line, Tlen, _, _) ->
...
yystate(14, [32|Ics], Line, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 58 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(14, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,14};
yystate(13, [233|Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(10, Ics, Line, Tlen, _, _) ->
    {13,Tlen,Ics,Line};
yystate(9, [233|Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(5, Ics, Line, Tlen, _, _) ->
    {9,Tlen,Ics,Line,5};
yystate(4, [233|Ics], Line, Tlen, Action, Alen) ->
...
yyaction_11(TokenChars, TokenLine) ->
     { toke, comentario (TokenLine, TokenChars) } .
